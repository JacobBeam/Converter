...
import whitekCard from './img/white-card.png';
...
function App() {
  ...
  <main>
    <section className="promo">
      ...
      <div className="promo__cintainer container">
        <div className="promo__info">
          ...
          <button className="promo-button">Рассчитать кредит</button>
        </div>
        <div className="promo__wrapper">
          <img src={blackCard} alt="Черная кредитная карта" className="promo__main-img" />
          <img src={whitekCard} alt="Белая кредитная карта" className="promo__secong-img" />
        </div>
      </div>
    </section>
    <srction className="converter">
      <h1 className="converter__title">Конвертер валют</h1>
      <div className="converter-_container container">
    ...
    <section className="history">
      <div className="histori__container container">
  ...
  <footer className="footer">
    <div className="container footer-nav">
      <div className="footer-nav__wrapper">
        <a href className="footer-nav__logo logo">
          <img src={logo} alt="Логотип ЛигаБанк" className="logo__img" height={25} width={149} />
        </a>
        <p className="footer-nav__text">150015, г. Москва, ул. Московская, д. 32</p>
        <p className="footer-nav__text"> Генеральная лицензия Банка России №1050</p>
        <p className="footer-nav__text"> Ⓒ Лига Банк, 2019</p>
      </div>
      <div className="footer-nav__wrapper">
      ...
      <div className="footer-nav__wrapper contact-info">
      ...
      <div className="footer-nav__wrapper socials">
